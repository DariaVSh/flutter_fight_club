          ...
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: SizedBox(
                  width: double.infinity, child: ColoredBox(color: FightClubColors.purpleColor,)),
              ),
            ),
            SizedBox(height: 30,),
            ControlsWidget(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(child: ColoredBox(
                color: FightClubColors.purpleColor,
              ),
              ),
            ],
          ),
        ...
        child: ColoredBox(
          ...
          child: Center(
            child: Text(bodyPart.name.toUpperCase(),
              style: TextStyle(
                  color: selected
                      ?  FightClubColors.whiteText : FightClubColors.darkGreyText
              ),),
          ),
        ),
      ),
